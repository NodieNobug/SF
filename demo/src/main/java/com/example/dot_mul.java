...
// doObj.getDot_r();
// // DO计算第一轮结果
// BigInteger[] firstRoundResult =
// doObj.calculateFirstRound(encryptedCspVectors, csp_p, csp_alpha);
// // DO将第一轮结果发送给CSP
...
// for (DO doObj : doList) {
// BigInteger[] finalResult = csp.calculateFinalDotProduct(doObj.getId(),
// csp_p);
